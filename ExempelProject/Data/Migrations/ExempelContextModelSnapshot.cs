...
{
    [DbContext(typeof(ExempelContext))]
    partial class ExempelContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExempelProject.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2022, 9, 6, 19, 53, 13, 437, DateTimeKind.Utc).AddTicks(7194),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("ExempelProject.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("ExempelProject.Data.Entities.Order", b =>
                {
                    b.HasOne("ExempelProject.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ExempelProject.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
